...
If the type hadn't been fixed then the underlying type would have been `int` (which is at least 16 bits, but can be as much as 32 bits or 64 bits depending on the system).
